...
SelectIntervalEvent = [
    ...
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.rename: utilization",
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.decode: utilization",
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.dispatch: utilization",
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.intDq: utilization",
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.fpDq: utilization",
    "TOP.SimTop.l_soc.core_with_l2.core.ctrlBlock.lsDq: utilization",
    ]
...
def Write_Data(client):
    ...
    while Index1 < AllIntervalResultLength and Index2  < AllLastResultlength:
        ...
        while Index1 < AllIntervalResultLength and Cycle == AllIntervalResult[Index1][0]:
            IntervalStats[AllIntervalResult[Index1][1]] = int(AllIntervalResult[Index1][2])/100000
